...
public class Privilege implements TBase<Privilege, Privilege._Fields>, java.io.Serializable, Cloneable {
  ...
  private static final TField LINK_FIELD_DESC = new TField("link", TType.STRING, (short)4);
  private static final TField CREATE_TIME_FIELD_DESC = new TField("createTime", TType.I64, (short)5);
  private static final TField UPDATE_TIME_FIELD_DESC = new TField("updateTime", TType.I64, (short)6);
  ...
  public int compareTo(Privilege other) {
    ...
    Privilege typedOther = (Privilege)other;
